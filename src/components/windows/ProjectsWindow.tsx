...
const projects = [
  ...
  },
  {
    title: "CrispyTime",
    description:
      "Designed and developed a responsive, sleek restaurant website using ReactTS, Vite, TailwindCSS and shadcn-ui that allows users to add menu items to a cart, manage order quantities, and send the finalized order to the restaurant via WhatsApp in a structured, readable message format.",
  ...
  },
  {
    ...
    description:
      "Helped develop the frontend of Yanta Municipality's website, creating a responsive and user-friendly interface that allows residents and visitors to access municipal information, announcements, and services.",
    tech: ["Next.js"],
  ...
  },
  {
    title: "Tiramisu Shop",
    description:
      "Built a responsive single-page website for a tiramisu shop using React and Vite, showcasing products with clean design, fast performance, and seamless deployment on Vercel.",
    tech: ["ReactJS", "CSS"],
    link: "https://glitch-portfolio-teal.vercel.app/",
  ...
  {
    title: "Student Portfolio – Manuela Frierre",
    description:
  ...
  },
  {
    title: "Jingle Jings",
    description:
      "One-page website built for a small business in Brazil using React.",
    tech: ["ReactJS", "CSS"],
  ...
  },
  {
    ...
    description:
      "WordPress website for a Saudi consulting firm offering governance, financial, and operational advisory services. SEO: metadata structure and page speed improvements.",
  ...
  },
  {
    ...
    description:
      "WordPress mental health clinic website with a mobile-first design. SEO: content structure optimization and mobile-first indexing improvements.",
    tech: ["WordPress", "Elementor Pro"],
  ...
  },
  {
    title: "Hizzek Mizzek",
    description:
      "WordPress e-commerce website for a Lebanese gift and snack business with DHL shipping integration. SEO: product taxonomy and schema markup.",
    tech: ["WordPress", "Elementor Pro"],
  ...
  },
  {
    ...
    description:
      "WordPress perfume e-commerce store with categorized products for Men, Women, and Unisex. SEO: metadata, image optimization, and performance improvements.",
    tech: ["WordPress", "Elementor Pro"],
